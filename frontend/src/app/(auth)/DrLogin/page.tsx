    ...
    <>
      ...
      <AnimatedContainer>
        <div className="h-screen flex items-center justify-center flex-col ">
          <form action={formAction} className="rounded-2xl py-8 px-10 border-1 border-zinc-200 w-[27rem] shadow-xl shadow-zinc-200 z-20 bg-white">
  ...
  return (
    <button className="w-full flex items-center justify-center gap-2 hover:bg-primary hover:text-white bg-primaryLight cursor-pointer py-2 mt-3 rounded-sm duration-300 ">
      {pending ? (
        ...
        <>
          <p className="text-[.9rem]">ورود دکتر</p>
