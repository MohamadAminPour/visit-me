...
const links: ILinks[] = [
  { id: 1, title: "داشبورد", link: "/sick/dashboard" },
  { id: 2, title: "دکتر ها", link: "/sick/doctors" },
  { id: 3, title: "بیماران", link: "/sick/sicks" },
  { id: 4, title: "درخواست دکتر", link: "/sick/drRequests" },
];
